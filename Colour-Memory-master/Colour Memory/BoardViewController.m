...
- (void)viewDidLoad{
    ...
    /* The panel in which the player's name is entered is hidden before sending the score to the server */
    CGFloat x1 = 465;
    CGFloat y1 = 90;
...
- (IBAction)selectedCard:(id)sender {
    ...
    /* When the first letter is selected, execute this conditional */
    ...
    /*If the selection of the second card is performed, execute this conditional*/
    ...
    if(intents == 2){
        ...
        /*If you hit the selection of both cards add 2 points in the score */
        ...
        if([colorIntent1 isEqualToString:colorIntent2]){
            ...
            /*If the cards are finished on the board, the game ends and the panel is displayed to enter the player's name */
        ...
        /*If he fails to select the cards, We subtracts 1 point from the score */
            ...
            /*As it has failed, the cards are flipped again */
